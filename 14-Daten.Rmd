...
```{r}
summary(bikesharing$cnt) # Deskriptive Statistik der benutzten Fahrräder pro Tag
```
...
```{r}
summary(boatprices$price) # Deskriptive Statistik des Preises der 
                          # gelisteten Boote in Euro
```
...
```{r}
summary(insurance$charges) # Deskriptive Statistik der jährlichen
                           # Versicherungskosten in US Dollar
```
