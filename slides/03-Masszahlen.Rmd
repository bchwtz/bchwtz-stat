...
\pause
\small
- Rechtsschiefe Häufigkeitsverteilung: $\bar x > \bar x_{Median} > \bar x_{Median}$
- Linksschiefe Häufigkeitsverteilung: $\bar x = \bar x_{Median} = \bar x_{Median}$
- Symmetrische Häufigkeitsverteilung: $\bar x < \bar x_{Median} < \bar x_{Median}$
