...
Rechtsseitig & $\mu \leq \mu_0$ & $\mu > \mu_0$    &                                                               & $z< z_{\alpha}$                 \\
Linksseitig  & $\mu \geq \mu_0$ & $\mu < \mu_0$    &                                                               & $z > z_{1-\alpha}$              \\ \bottomrule
\end{tabular}
\end{table}
...
Rechtsseitig & $\mu \leq \mu_0$ & $\mu > \mu_0$    &                                                          & $t < t_{n-1, \;\alpha}$                \\
Linksseitig  & $\mu \geq \mu_0$ & $\mu < \mu_0$    &                                                          & $t > t_{n-1, \; 1-\alpha}$             \\ \bottomrule
\end{tabular}
\end{table}
...
Rechtsseitig & $\pi \leq \pi_0$ & $\pi > \pi_0$    &                                                                         & $z < z_\alpha$                  \\
Linksseitig  & $\pi \geq \pi_0$ & $\pi < \pi_0$    &                                                                         & $z > z_{1-\alpha}$              \\ \bottomrule
\end{tabular}
\end{table}
