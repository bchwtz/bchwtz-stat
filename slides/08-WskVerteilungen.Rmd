...
\bigskip
- Bei der gewählten Zuorndung kann man die Zufallsvariable $X$ auch als *Anzahl des Auftretens von Zahl beim Werfen einer Münze* auffassen.
...
- **Beispiel:** Anzhal der Kinder unter 18 Jahre in einem Haushalt
...
- $F(x)$ is monoton steigend
- $\lim_{x \to -\infty} F(X) = 0$
- $\lim_{x \to \infty} F(X) = 1$
- $F(x)$ is in jedem Punkt (zumindest rechtsseitig) stetig
...
- **Beispiel:** Definieren Sie die Zufallsvariable $X$ für das Werfen eines Würfels und berechnen Sie deren Erwartungswert.
...
- **Beispiel:** Definieren Sie die Zufallsvariable $X$ für das Werfen eines Würfels und berechnen Sie deren Varianz.
