...
- Um Multikollinearitätprobleme zu diagnostizieren, müssen die Zusammenhangsstrukturen zwischen den Prädiktoren untersucht werden. Das beinhaltet die Analyse des $R^2$, das aus der Regression jedes Prädiktors auf alle verbleibenden Prädiktoren resultiert.
